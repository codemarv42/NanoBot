...
bool TCSL_Green() {    
   ...
   if ((RAW_TCS_L[R] < 0.85) && (RAW_TCS_L[G] < 1.25) && (RAW_TCS_L[B] < 1.20) && (RAW_TCS_L[R] > 0.70) && (RAW_TCS_L[G] > 1.05) && (RAW_TCS_L[B] > 1.00)){
     return true;
   }else{
     return false;
   }
...
bool TCSR_Green() {      
   ...
   if ((RAW_TCS_R[R] < 0.85) && (RAW_TCS_R[G] < 1.25) && (RAW_TCS_R[B] < 1.20) && (RAW_TCS_R[R] > 0.70) && (RAW_TCS_R[G] > 1.05) && (RAW_TCS_R[B] > 1.00)){
     return true;
   }else{
     return false;
   }
...
bool TCSL_Red() {     
  ...
  if ((RAW_TCS_L[R] < 1.55) && (RAW_TCS_L[G] < 0.90) && (RAW_TCS_L[B] < 1.00) && (RAW_TCS_L[R] > 1.35) && (RAW_TCS_L[G] > 0.6) && (RAW_TCS_L[B] > 0.65)) {
    return true;
  }else{
    return false;
  }
...
bool TCSR_Red() {    
  ...
  if ((RAW_TCS_R[R] < 1.55) && (RAW_TCS_R[G] < 0.90) && (RAW_TCS_R[B] < 1.00) && (RAW_TCS_R[R] > 1.35) && (RAW_TCS_R[G] > 0.6) && (RAW_TCS_R[B] > 0.65)) {
    return true;
  }else{
    return false;
  }
