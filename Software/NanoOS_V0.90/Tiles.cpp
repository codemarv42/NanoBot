...
void CaseDistinction() {  //Tiles case distinction
  ...
  } else if ((CAL_L[L_A2] < Black + 50) || (CAL_L[R_A2] < Black + 50)) {

    if ((CAL_L[L_A2] < Black + 50) && (CAL_L[R_A2] < Black + 50)){
      RGBOff();
      SetRGB(2, B);
