...
extern void PrintDataSerial(bool mode);

extern void DriveTime(int time);
...
extern bool ForceDispUpdate;

extern void SetRGB(unsigned int select, int color);
extern void RGBOff();

extern unsigned int Core0Time;
extern void CalculateCoreTime(bool a);

extern bool ENShutdownBT;
