...
/*
   1. TO-DO:
   -Rot Erkennung und Grünerkennung kalibrieren + Grün Erkennung werte vorher speichern
   -End Raum Algorythmus
   -Räder mit Tape stützen

   2. TO-DO:
   -Problem mit Kreuzung
   -Button drücken und Roboter resetten nur im Contest mode aktivieren
   -Dose Umfahren alle Fälle abdecken
   -Save cal Gyro data
