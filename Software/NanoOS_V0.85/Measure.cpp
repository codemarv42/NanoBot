...
unsigned int RAW_TCS_L[3] = { R, G, B};  //Raw RGB values
unsigned int RAW_TCS_R[3] = { R, G, B};
...
bool TCSL_Green() {    
   ...
   if ((RAW_TCS_L[R] < 70) && (RAW_TCS_L[G] < 105) && (RAW_TCS_L[B] < 100) && (RAW_TCS_L[R] > 50) && (RAW_TCS_L[G] > 85) && (RAW_TCS_L[B] > 80)){
     return true;
   }else{
     return false;
   }
  
  /*                                                               //True - green, False - No green //Looks if it is the calibrated color
...
bool TCSR_Green() {      
   ...
   if ((RAW_TCS_R[R] < 70) && (RAW_TCS_R[G] < 105) && (RAW_TCS_R[B] < 100) && (RAW_TCS_R[R] > 50) && (RAW_TCS_R[G] > 85) && (RAW_TCS_R[B] > 80)){
     return true;
   }else{
     return false;
   }
...
bool TCSL_Red() {     
  ...
  if ((RAW_TCS_L[R] > 70) && (RAW_TCS_L[G] < 77) && (RAW_TCS_L[B] < 110)) {
    return true;
  }else{
    return false;
  }

  /*                                                                 //True - red, False - No red //Looks if it is the calibrated color
